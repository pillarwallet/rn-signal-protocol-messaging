...
RCT_EXTERN_METHOD(createClient:(NSString *)username accessToken:(NSString *)accessToken host:(NSString *)host resolver: (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject);
