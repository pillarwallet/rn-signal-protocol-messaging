...
public class ProtobufWebSocketMessageFactory implements WebSocketMessageFactory {
    ...
    public WebSocketMessage createRequest(Long requestId,
        ...
        if (requestId != null) {
            requestMessage.setId(requestId);
        }
    ...
    public WebSocketMessage createRequest(Long requestId,
                                          String verb, String path) {
        return createRequest(requestId, verb, path, null, null);
    }

    @Override
    public WebSocketMessage createResponse(long requestId, int status, String messageString, List<String> headers, byte[] body) {
        ...
        if (body != null) {
            responseMessage.setBody(ByteString.copyFrom(body));
        }
